...
urlpatterns = [
    ...
    path('position_history_list', position_history_list),
    path('employee_history_list', employee_history_list),

    path('activity_history_list', activity_history_list),

    path('save_position_file',save_position_file)
