    ...
    # try:
        ...
        for rdata in sheet_data:
            ...
            if pos_currency != local_curr_type:
                ...
                pos_currency_annual_base_pay = temp_usd_val * float(curr_obj.usd_average)
            ...
            rdata['gbp_new_annual_base_pay'] = rdata['gbp_annual_base_pay']
            rdata['usd_new_annual_base_pay'] = rdata['usd_annual_base_pay']
            rdata['euro_new_annual_base_pay'] = rdata['euro_annual_base_pay']
            ...
            if baseLine_serializer.is_valid(raise_exception=True):
                ...
                pos_data = {
                    ...
                    "gbp_new_annual_base_pay":baseline_obj.gbp_annual_base_pay,
                    "usd_new_annual_base_pay":baseline_obj.usd_annual_base_pay,
                    "euro_new_annual_base_pay":baseline_obj.euro_annual_base_pay
                }
